...
class Profile extends React.Component {
  ...
  profileSubmitHandler = async profileValues => {
    console.log("profile update handled");
    console.log("================");
    console.log(profileValues);
    console.log("================");

    const updateProfile = await fetch(
      process.env.REACT_APP_BACKEND + `company/updateProfile`,
      {
        method: "POST",
        body: JSON.stringify({
    ...
    console.log(process.env.REACT_APP_BACKEND + "#/company-dashboard/home");
    window.location.href =
      process.env.REACT_APP_BACKEND + "#/company-dashboard/home";
  };

  // profileStateHandler = async () => {
  //   console.log("profile state handler fired");
  //   const updateProfile = await fetch(
  //     process.env.REACT_APP_BACKEND + `company/profileInformation`,
  //     {
  //       method: "GET",
  //       credentials: "include",
  //       headers: {
  ...
  //     }
  //   );
  //   const parsedRes = await updateProfile.json();
  //   const profileState = JSON.parse(parsedRes.data.profileData);
  ...
  //     partnerHomePhone: "",
  //     partnerWorkPhone: "",
  //     annualRevenue: profileState.fundingInformation.annualRevenue,
  //     monthlyRevenue: profileState.fundingInformation.monthlyRevenue,
  //     amountSeeking: profileState.fundingInformation.amountSeeking,
                    ...
                    <Form onSubmit={handleSubmit} noValidate name="simpleForm">
                      ...
                      <FormGroup>
                        <Button
                          ...
                          color="primary"
                          className="mr-1"
                          onClick={() => this.profileSubmitHandler(values)}
                        >
                          Submit
                        </Button>
                        <Button
